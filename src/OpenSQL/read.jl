...
function read_scalar_relations(
    ...
    names_in_collection_to = read_scalar_parameters(opensql_db, collection_to, "label")
    ids_in_collection_to = read_scalar_parameters(opensql_db, collection_to, "id")
...
function read_scalar_relation(
    ...
    labels_in_collection_from = read_scalar_parameters(opensql_db, collection_from, "label")
...
function _get_scalar_relation_map(
    ...
    ids_in_collection_from = read_scalar_parameters(opensql_db, collection_from, "id")
