...
function _get_attribute(
    ...
    elseif _is_vector_parameter(opensql_db, collection_name, attribute_name)
        return collection.vector_parameters[attribute_name]
    elseif _is_scalar_relation(opensql_db, collection_name, attribute_name)
        return collection.scalar_relations[attribute_name]
    elseif _is_vector_relation(opensql_db, collection_name, attribute_name)
        return collection.vector_relations[attribute_name]
    elseif _is_time_series_file(opensql_db, collection_name, attribute_name)
