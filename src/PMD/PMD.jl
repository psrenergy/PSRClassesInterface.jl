...
const _MODEL_TO_CLASS = Dict(
    ...
    "SDDP_V10.2_Interconnection" => "PSRInterconnections",
    ...
    "SDDP_RestricaoSomaInterconexao" => "PSRConstraintSumInterconnections",
    "SDDP_RestricaoSomaCircuito" => "PSRConstraintSumCircuits",
