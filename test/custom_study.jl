function test_custom()
    ...
    PSRI.create_element!(data, "ThermalPlants",
        "Capacity"                => 1.0,
        "SpecificConsumptionDate" => [Dates.Date(2022,1,1),Dates.Date(2022,1,8),Dates.Date(2022,1,15)],
    ...
    vec1 = PSRI.mapped_vector(data, "ThermalPlants", "SpecificConsumption", Float64, "segment")
