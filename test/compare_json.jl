...
@test logs[1:13] == ["[PSRFuelConsumption][1][fuel]",
                    "[PSRFuelConsumption][1][CEsp(1,1)][1]",    
                    "[PSRFuelConsumption][2][fuel]",
                    "[PSRFuelConsumption][2][CEsp(1,1)][1]",    
                    "[PSRFuelConsumption][3][fuel]",
...
@test logs[end-11:end] == ["[PSRSystem][1][TipoInfoManutencaoHidro]",
                    "[PSRSystem][1][name]",
                    "[PSRSystem][1][TipoUnidadeReservaGeracao]",
