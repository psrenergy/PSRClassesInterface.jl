...
function test_is_equal()
    ...
    file_1 = create_time_series(".\\test_isequal_1"; stages = 10)
    file_2 = create_time_series(".\\test_isequal_2"; stages = 9)
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
    PSRI.close(ior2)
    rm(file_1 * ".bin")
    rm(file_1 * ".hdr")
    ...
    file_1 = create_time_series(".\\test_isequal_1"; blocks = 3)
    file_2 = create_time_series(".\\test_isequal_2"; blocks = 5)
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
    ...
    file_1 = create_time_series(".\\test_isequal_1"; unit = "MW")
    file_2 = create_time_series(".\\test_isequal_2"; unit = "MWm")
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
    ...
    file_1 = create_time_series(".\\test_isequal_1"; agents = ["W", "X", "Y", "Z"])
    file_2 = create_time_series(".\\test_isequal_2")
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
    ...
    file_1 = create_time_series(".\\test_isequal_1"; initial_stage = 1)
    file_2 = create_time_series(".\\test_isequal_2"; initial_stage = 2)
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
    ...
    file_1 = create_time_series(".\\test_isequal_1"; offset = 0)
    file_2 = create_time_series(".\\test_isequal_2"; offset = 1)
    ior1 = PSRI.open(PSRI.OpenBinary.Reader, file_1, use_header = false)
    ior2 = PSRI.open(PSRI.OpenBinary.Reader, file_2, use_header = false)
    @test_throws AssertionError PSRI.is_equal(ior1, ior2)
    PSRI.close(ior1)
