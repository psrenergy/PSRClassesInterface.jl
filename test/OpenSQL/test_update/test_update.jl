...
function test_create_scalar_relations()
    ...
    # Valid relations
    OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 1", "Resource 1", "id")
    OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 1", "Resource 2", "id")
    OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 2", "Resource 1", "id")
    OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 3", "Resource 2", "id")
    OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant 3", "Plant 1", "turbine_to")
    OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant 1", "Plant 2", "spill_to")

    # invalid relations
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 1", "Resource 1", "wrong")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 1", "Resource 4", "id")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Resource", "Plant 5", "Resource 1", "id")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Resource", "Resource", "Resource 1", "Resource 2", "wrong")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant 1", "Plant 2", "wrong")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant 1", "Plant 1", "turbine_to")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant 1", "Plant 2", "id")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Plant", "Plant", "Plant", "id")
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Plant 1", "Plant", "Plant 2", "id")
...
function test_create_vector_relations()
    ...
    @test_throws ErrorException OpenSQL.set_scalar_relation!(db, "Plant", "Cost", "Plant 1", ["Cost 1"], "some_relation_type")
    OpenSQL.set_vector_relation!(db, "Plant", "Cost", "Plant 1", ["Cost 1"], "some_relation_type")
    OpenSQL.set_vector_relation!(db, "Plant", "Cost", "Plant 2", ["Cost 1", "Cost 2", "Cost 3"], "some_relation_type")
    OpenSQL.set_vector_relation!(db, "Plant", "Cost", "Plant 4", ["Cost 1", "Cost 3"], "id")
    @test_throws ErrorException OpenSQL.set_vector_relation!(db, "Plant", "Cost", "Plant 2", ["Cost 10", "Cost 2"], "some_relation_type")
    @test_throws ErrorException OpenSQL.set_vector_relation!(db, "Plant", "Cost", "Plant 2", ["Cost 1", "Cost 2", "Cost 3"], "wrong")
...
function test_update_vector_parameters()
    ...
    OpenSQL.update_vector_parameters!(db, "Resource", "some_value_1", "Resource 1", [4.0, 5.0, 6.0])
    OpenSQL.update_vector_parameters!(db, "Resource", "some_value_2", "Resource 1", [4.0, 5.0, 6.0])
    @test_throws ErrorException OpenSQL.update_vector_parameters!(db, "Resource", "some_value_3", "Resource 1", [4.0, 5.0, 6.0])
    @test_throws ErrorException OpenSQL.update_vector_parameters!(db, "Resource", "some_value_1", "Resource 1", [1, 2, 3])
    @test_throws ErrorException OpenSQL.update_vector_parameters!(db, "Resource", "some_value_1", "Resource 1", [4.0, 5.0, 6.0, 7.0])
    OpenSQL.close!(db)
    rm(db_path)
end
