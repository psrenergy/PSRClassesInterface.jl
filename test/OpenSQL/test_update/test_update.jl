...
function test_create_scalar_relations()
    ...
    # invalid relations
    @test_throws ErrorException OpenSQL.set_scalar_relation!(
        db,
        "Plant",
        "Resource",
        "Plant 1",
...
function test_create_vector_relations()
    ...
    @test_throws ErrorException OpenSQL.set_vector_relation!(
        db,
        "Plant",
        "Cost",
        "Plant 2",
...
function test_update_vector_parameters()
    ...
    @test_throws ErrorException OpenSQL.update_vector_parameters!(
        db,
        "Resource",
        "some_value_3",
        "Resource 1",
