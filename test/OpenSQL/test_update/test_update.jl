...
function test_create_scalar_relationships()
    ...
    # Valid relationships
    OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 1", "Resource 1", "id")
    OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 1", "Resource 2", "id")
    OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 2", "Resource 1", "id")
    OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 3", "Resource 2", "id")
    OpenSQL.set_relationship!(db, "Plant", "Plant", "Plant 3", "Plant 1", "turbine_to")
    OpenSQL.set_relationship!(db, "Plant", "Plant", "Plant 1", "Plant 2", "spill_to")

    # invalid relationships
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 1", "Resource 1", "wrong")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 1", "Resource 4", "id")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Resource", "Plant 5", "Resource 1", "id")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Resource", "Resource", "Resource 1", "Resource 2", "wrong")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Plant", "Plant 1", "Plant 2", "wrong")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Plant", "Plant 1", "Plant 1", "turbine_to")
    @test_throws ErrorException OpenSQL.set_relationship!(db, "Plant", "Plant", "Plant 1", "Plant 2", "id")
...
function test_update_scalar_parameters()
    ...
    OpenSQL.update_element!(db, "Resource", "Resource 1"; type = "D", some_value_1 = 1.0, some_value_2 = 90)
    @test_throws SQLite.SQLiteException OpenSQL.update_element!(db, "Resource", "Resource 1"; type = "D", some_value_1 = 1.0, some_value_2 = "wrong!")
