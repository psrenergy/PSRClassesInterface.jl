...
function test_update_vectorial_parameters()
    ...
    OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_1 = [4.0, 5.0, 6.0])
    OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_2 = [0.0, 5.0, 6.0])
    @test_throws ErrorException OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 4"; some_value_1 = [1.0, 2.0, 3.0])
    @test_throws ErrorException OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_3 = [1.0, 2.0, 3.0])
    OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_1 = [1.0, 2.0, 3.0], some_value_2 = [90, 80, 70])
    @test_throws ErrorException OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_2 = [0.0, 5.0, 6.0, 9.0])
    @test_throws SQLite.SQLiteException OpenSQL.update_vectorial_parameters!(db, "Resource", "Resource 1"; some_value_2 = [90, 80, "wrong!"])
    OpenSQL.close!(db)
    rm(db_path)
end
